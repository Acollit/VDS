...
/* harmony import */ var _components_acardion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/acardion */ "./src/js/components/acardion.js");
/* harmony import */ var _components_acardion__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_acardion__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _components_validate__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/validate */ "./src/js/components/validate.js");
/* harmony import */ var _components_validate__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_validate__WEBPACK_IMPORTED_MODULE_6__);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  item.forEach(el => {
    el.addEventListener('click', e => {
      ...
      const text = self.querySelector(".faq__text");
      const title = self.querySelector(".faq__subtitle");
      text.classList.toggle('faq__text--active');
      self.classList.toggle('faq__item--active');
      btn.classList.toggle('faq__btn--active');
      title.classList.toggle('faq__subtitle--active');

      if (text.classList.contains('faq__text--active')) {
...
document.addEventListener('DOMContentLoaded', () => {
  const item = document.querySelectorAll(".program__inner");
  item.forEach(el => {
    el.addEventListener('click', e => {
      const self = e.currentTarget;
      const btn = self.querySelector(".program__acardion");
      const text = self.querySelector(".program__list");
      const title = self.querySelector(".program__subtitle");
      text.classList.toggle('program__list--active');
      self.classList.toggle('program__inner--active');
      btn.classList.toggle('program__acardion--active');
      title.classList.toggle('program__subtitle--active');

      if (text.classList.contains('program__list--active')) {
        text.style.maxHeight = text.scrollHeight + 'px';
      } else {
        text.style.maxHeight = null;
      }

      if (btn.classList.contains('program__acardion--active')) {
...
let center = [55.837274, 37.479374];
let center2 = [56.270866, 37.467876];
setTimeout(function () {
  ymaps.ready(init);
  ymaps.ready(init2);
}, 5000);
...
function init() {
  ...
  let placemark = new ymaps.Placemark([55.837274, 37.479374], {}, {
...
function init2() {
  ...
  let placemark = new ymaps.Placemark([56.270866, 37.467876], {}, {
    preset: 'islands#redDotIcon'
  });
  map.controls.remove('geolocationControl'); // удаляем геолокацию
...
const form2 = document.querySelector(".form__form-1");
const form3 = document.querySelector(".graph-modal__form");
const form4 = document.querySelector(".graph-modal__form-two");
...
new window.JustValidate('.form__form-1', {
  rules: {
    tel: {
      required: true
    },
...
new window.JustValidate('.graph-modal__form', {
  rules: {
    tel: {
      required: true
    },
  ...
  submitHandler: function (thisForm) {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        if (xhr.status === 200) {
          console.log('Отправлено');
          document.querySelector('.graph-modal__form').classList.add('graph-modal__form--active');
          document.querySelector('.graph-modal__complit').classList.add('graph-modal__complit--active');
          document.querySelector('.graph-modal__subtitle').classList.add('graph-modal__subtitle--active');
        }
      }
    };
...
new window.JustValidate('.graph-modal__form-two', {
  rules: {
    tel: {
      required: true
    },
  ...
  submitHandler: function (thisForm) {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        if (xhr.status === 200) {
          console.log('Отправлено');
          const modal2 = document.querySelector('.graph-modal__wrapper--two');
          modal2.querySelector('.graph-modal__form-two').classList.add('graph-modal__form-two--active');
          modal2.querySelector('.graph-modal__complit').classList.add('graph-modal__complit--active');
          modal2.querySelector('.graph-modal__subtitle').classList.add('graph-modal__subtitle--active');
        }
      }
    };

    xhr.open('POST', 'mail3.php', true);
    xhr.send(formData);
    thisForm.reset();
  }
});
        ...
        Object.defineProperty(t, "__esModule", {
          ...
          if (u(this[0])) for (var n = this[0].eventRegistry, a = this[0], o = "string" == typeof e ? e.split(" ") : [e.type], l = 0; l < o.length; l++) {
            ...
            if (void 0 !== c && "global" === p) {
              ...
              } else (d = c.createEventObject()).eventType = f, d.detail = arguments[1], e.type && (0, i.default)(d, e), a.fireEvent("on" + d.eventType, d);
            } else if (void 0 !== n[f]) {
      ...
      219: function (e, t, n) {
          ...
          return t = e, (n = [{
            ...
            value: function (e, t, n, i, a) {
              if (void 0 !== t && (e[i] = "ampm" === i || "mmm" === n || "mmmm" === n ? t : t.replace(/[^0-9]/g, "0"), e["raw" + i] = t.replace(/\s/g, "_")), void 0 !== a) {
                var r = e[i];
                ("day" === i && 29 === parseInt(r) || "month" === i && 2 === parseInt(r)) && (29 !== parseInt(e.day) || 2 !== parseInt(e.month) || "" !== e.year && void 0 !== e.year || e._date.setFullYear(2012, 1, 29)), "day" === i && (g = !0, 0 === parseInt(r) && (r = 1)), "month" === i && (g = !0), "year" === i && (g = !0, r.length < 4 && (r = _(r, 4, !0))), ("" !== r && !isNaN(r) || "ampm" === i || "mmm" === n || "mmmm" === n) && a.call(e._date, r);
              }
            }
          }, {
            key: "reset",
        ...
        function O(e, t, n, i) {
          ...
          for (w(n).lastIndex = 0; a = w(n).exec(e);) {
            if (void 0 === t) {
              if (o = P(a)) l += "(" + o[0] + ")", c[s] = a[0].charAt(0);else switch (a[0]) {
                case "[":
                  l += "(";
                  break;
            ...
            if ((s = m.pop()).openGroup = !1, void 0 !== s) {
              if (m.length > 0) {
                if ((c = m[m.length - 1]).matches.push(s), c.isAlternator) {
                  for (var e = (u = m.pop()).matches[0].matches ? u.matches[0].matches.length : 1, t = 0; t < u.matches.length; t++) u.matches[t].isGroup = !1, u.matches[t].alternatorGroup = !1, null === n.keepStatic && e < (u.matches[t].matches ? u.matches[t].matches.length : 1) && (n.keepStatic = !0), e = u.matches[t].matches ? u.matches[t].matches.length : 1;
          ...
          for (; i = t ? d.exec(e) : p.exec(e);) {
            ...
            if (h) b();else switch (o.charAt(0)) {
              ...
              case n.alternatormarker:
                ...
                if (f.isAlternator) m.push(f);else if (f.alternatorGroup ? (u = m.pop(), f.alternatorGroup = !1) : u = new a.default(!1, !1, !1, !0), u.matches.push(f), m.push(u), f.openGroup) {
                  f.openGroup = !1;
      ...
      4713: function (e, t, n) {
          ...
          if (!0 === t.static) {
            if (e > -1 && void 0 === l.validPositions[e]) {
              var u,
                  f = h.call(i, e),
                  d = [];
              if (f.length > 1 + ("" === f[f.length - 1].match.def ? 1 : 0)) for (var v = 0; v < f.length; v++) if ("" !== f[v].match.def && !0 !== f[v].match.optionality && !0 !== f[v].match.optionalQuantifier && (!0 === f[v].match.static || void 0 === u || !1 !== f[v].match.fn.test(u.match.def, l, e, !0, r)) && (d.push(f[v]), !0 === f[v].match.static && (u = f[v]), d.length > 1 && /[0-9a-bA-Z]/.test(d[0].match.def))) return r.placeholder.charAt(e % r.placeholder.length);
            }
        ...
        function f(e, t) {
          ...
          for (var u = 0; u < t.length - i; u++) {
            ...
            r = l(f, c.length);
            var d = Math.abs(r - c);
            (void 0 === o || "" !== r && d < o || s && !n.greedy && s.match.optionality && s.match.optionality - a > 0 && "master" === s.match.newBlockMarker && (!f.match.optionality || f.match.optionality - a < 1 || !f.match.newBlockMarker) || s && !n.greedy && s.match.optionalQuantifier && !f.match.optionalQuantifier) && (o = d, s = f);
          }
        ...
        function h(e, t, n) {
                  ...
                  for (var r = a, o = !1, u = n.length > 0 ? n.shift() : 0; u < (isNaN(r.quantifier.max) ? u + 1 : r.quantifier.max) && h <= e; u++) {
                    ...
                    if (a = f(p, [u].concat(l), p)) {
                      if (m.forEach(function (t, n) {
                        (i = b(p, t.match) ? t.match : m[m.length - 1].match).optionalQuantifier = u >= r.quantifier.min, i.jit = (u + 1) * (p.matches.indexOf(i) + 1) > r.quantifier.jit, i.optionalQuantifier && v(i, p) && (g = !0, h = e, c.greedy && null == s.validPositions[e - 1] && u > r.quantifier.min && -1 != ["*", "+"].indexOf(r.quantifier.max) && (m.pop(), y = void 0), o = !0, a = !1), !o && i.jit && (s.jitOffset[e] = p.matches.length - p.matches.indexOf(i));
                      }), o) break;
                      return !0;
                    }
                  }
          ...
          return (0 === m.length || g) && m.push({
            ...
            mloc: {},
            cd: y
          }), void 0 !== t && s.tests[e] ? a = l.extend(!0, [], m) : (s.tests[e] = l.extend(!0, [], m), a = s.tests[e]), m.forEach(function (e) {
      ...
      7215: function (e, t, n) {
        ...
        function l(e, t, n, a, o, s) {
          ...
          if (void 0 !== u) {
            ...
            for (-1 === A && void 0 !== t && (T.push(t), A = T.length - 1); void 0 !== S.excludes[m] && S.excludes[m].length < 10;) {
              for (S.tests = {}, r.resetMaskSet.call(x, !0), M = !0, h = 0; h < T.length && (g = M.caret || 0 == w.insertMode && null != g ? r.seekNext.call(x, g) : r.getLastValidPosition.call(x, void 0, !0) + 1, y = T[h], M = f.call(x, g, y, !1, a, !0)); h++) h === A && (E = M), 1 == e && M && (E = {
                caretPos: h
              });
        ...
        function v(e, t, n, a) {
          ...
          if (e.begin > e.end && (v = e.end, m = e.begin), a = void 0 !== a ? a : v, void 0 === n && (v !== m || s.insertMode && void 0 !== l.validPositions[a] || void 0 === t || t.match.optionalQuantifier || t.match.optionality)) {
            ...
            for (t && (l.validPositions[a] = c.extend(!0, {}, t), O++, S++), null == k[m] && l.jitOffset[m] && (m += l.jitOffset[m] + 1), y = t ? m : m - 1; y <= b; y++) {
            ...
            if (!g) return l.validPositions = c.extend(!0, [], k), r.resetMaskSet.call(o, !0), !1;
